...
async def start(client, message):
    ...
    if data.startswith("sendfiles"):
        ...
        k = await client.send_message(chat_id=message.from_user.id,text=f"<b>Get All Files in a Single Click!!!\n\n📂 ʟɪɴᴋ ➠ : {g}\n\n<i>Note: This message is deleted in 5 mins to avoid copyrights. Save the link to Somewhere else</i></b>", reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton('♻️ ᴄʟɪᴄᴋ ʜᴇʀᴇ ᴛᴏ ɢᴇᴛ ғɪʟᴇ ♻️', url=g)
                    ], [
                        InlineKeyboardButton('🤔 ᴄʜᴇᴄᴋ ʜᴏᴡ ᴛᴏ ᴏᴘᴇɴ ʟɪɴᴋ 🤔', url=await get_tutorial(chat_id))
                    ]
                ]
            )
        )
    ...
    if not files_:
        ...
        try:
            ...
            k = await msg.reply("<b><u>💢 ғɪʟᴇꜱ ᴡɪʟʟ ʙᴇ ᴅᴇʟᴇᴛᴇᴅ ɪɴ 𝟷𝟶 ᴍɪɴᴜᴛᴇꜱ ᴛᴏ ᴀᴠᴏɪᴅ ᴄᴏᴘʏʀɪɢʜᴛ ɪꜱꜱᴜᴇꜱ ‼️. ᴘʟᴇᴀꜱᴇ ғᴏʀᴡᴀʀᴅ ᴀɴᴅ ꜱᴀᴠᴇ ᴛʜᴇᴍ ♻️.</i></b>",quote=True)
            await asyncio.sleep(600)
            await msg.delete()
...
async def shortlink(bot, message):
    ...
    chat_type = message.chat.type
    if chat_type == enums.ChatType.PRIVATE:
        return await message.reply_text(f"<b>Hey {message.from_user.mention}, This command only works on groups !\n\n<u>Follow These Steps to Connect Shortener:</u>\n\n1. Add Me in Your Group with Full Admin Rights\n\n2. After Adding in Grp, Set your Shortener\n\nSend this command in your group\n\n—> /shortlink ""{your_shortener_website_name} {your_shortener_api}\n\n#Sample:-\n/shortlink linkcent.com 3d6d0459632263299128053dbe5b5765e66aceeb\n\nThat's it!!! Enjoy Earning Money 💲\n\n[[[ Trusted Earning Site - https://linkcent]]]\n\nIf you have any Doubts, Feel Free to Ask me - @Harikushal\n\n( contact - @Harikushal)</b>")
    elif chat_type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
    ...
    try:
        ...
        return await message.reply_text("<b>Command Incomplete :(\n\nGive me a shortener website link and api along with the command !\n\nFormat: <code>/shortlink modijiurl.com e3d82cdf8f9f4783c42170b515d1c271fb1c4500</code></b>")
